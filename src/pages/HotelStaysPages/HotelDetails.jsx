      ...
      <div className="container py-3">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item text-decoration-none text-success">
              Tiruvannamalai
            </li>
              ...
              <div>
                ...
                <div className="d-flex align-items-center gap-2 mb-2">
                  <div className="text-warning">
                    {"★".repeat(Math.round(property.overallRating || 0))}
                  </div>
            ...
            <div className="card mb-4">
              <div className="card-body">
                ...
                <div className="d-flex flex-wrap gap-3">
                  {property["Accommodation Facilities"]?.map(
                    (facility, index) => {
              ...
              <div className="card-body">
                ...
                <div className="d-flex align-items-center mb-4">
                  <div style={{ width: 60, height: 60 }}>
                    <CircularProgressbar
                      ...
                      styles={buildStyles({
                        textSize: "32px",
                        pathColor: `rgba(0, 59, 148, ${
                          property.overallRating / 5
                        })`,
                        textColor: "#038A5E",
                        trailColor: "#d6d6d6",
                      })}
                  ...
                  <div className="ms-3">
                    <div className="fw-bold">
                      {property.ratingLabel || "No rating"}
                    </div>
                ...
                {canSubmitReview && (
                  <div className="mt-4">
                    ...
                    {["staffReview", "luxury", "amenities", "price"].map(
                      (field) => (
                    ...
                    <div className="mb-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleReviewChange("comments", e.target.value)
                        }
                      ></textarea>
                    </div>
            ...
            <div className="card position-sticky mb-4">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center ">
                  ...
                  <span className="badge custom-primary fs-5">
                    {property.overallRating
                      ? Number.parseFloat(property.overallRating).toFixed(1)
                      : "4.5"}
                  </span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex align-items-center mb-3">
                    <button
                      ...
                      onClick={() =>
                        decrementValue(setAdults, adults, 1, "adults")
                      }
                    >
                      -
                    </button>
                    ...
                    <button
                      className="btn btn-outline-secondary"
                      onClick={() =>
                        incrementValue(setAdults, adults, 30, "adults")
                      }
                    >
                      +
                    </button>
                  ...
                  <div className="d-flex align-items-center mb-3">
                    <button
                      className="btn btn-outline-secondary"
                      onClick={() =>
                        decrementValue(setChildren, children, 0, "children")
                      }
                    >
                      -
                    </button>
                    ...
                    <button
                      className="btn btn-outline-secondary"
                      onClick={() =>
                        incrementValue(setChildren, children, 10, "children")
                      }
                    >
                      +
                    </button>
                  ...
                  <div className="d-flex align-items-center">
                    <button
                      className="btn btn-outline-secondary"
                      onClick={() =>
                        decrementValue(setRooms, rooms, 1, "rooms")
                      }
                    >
                      -
                    </button>
                    ...
                    <button
                      className="btn btn-outline-secondary"
                      onClick={() =>
                        incrementValue(setRooms, rooms, 30, "rooms")
                      }
                    >
                      +
                    </button>
                ...
                <div className="text-end mb-4">
                  <div className="h3 mb-0" style={{color: "#038a5eff"}}>
                    ₹{property.price ? property.price.toFixed(2) : "1500"}
                  </div>
