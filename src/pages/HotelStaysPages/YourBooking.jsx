...
// import { FaCheckCircle, FaHotel, FaCalendarAlt, FaUser, FaChild, FaMoneyBillWave } from "react-icons/fa"
...
//                     </p>
//                     <p className="mb-0">
//                       <strong>Booking Status:</strong> <span className="text-success">Booked</span>
//                     </p>
//                   </div>
//                 </div>
//               </div>
              ...
              <div className="card-body p-4 card shadow-sm mb-4 mt-3">
                ...
                <div className="text-center">
                  <button
                    ...
                    onClick={() => {
                      console.log("Navigating with:", bookingData); // 🧪 Check this logs properly
                      navigate("/PaymentPage", { state: { bookingData } });
                    }}
                  >
                    Proceed to Payment
